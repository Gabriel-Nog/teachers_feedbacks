        ...
        @php
            ...
            $isEmpty =
                request('type') != 'Alunos' && request('type') != 'Professores' && request('type') != 'Turmas'
                    ...
                    : false;
        @endphp
        <a class="{{ request('type') == 'Turmas' || $isEmpty ? $activedClass : $baseClass }}"
        href="/dashboard?type=Turmas">Turmas</a>
        <a class="{{ request('type') == 'Alunos' ? $activedClass: $baseClass }}"
            href="/dashboard?type=Alunos">Alunos</a>
        <a class="{{ request('type') == 'Professores' ? $activedClass : $baseClass }}"
            href="/dashboard?type=Professores">Professores</a>
